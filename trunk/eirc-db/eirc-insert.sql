...
INSERT INTO `import_error_type` (`code`, `name`) values
    ...
    (12, 'Соответствие для нас.пункта не может быть установлено'),
    (13, 'Соответствие для типа улицы не может быть установлено'),
    (14, 'Соответствие для улицы не может быть установлено'),
    (15, 'Соответствие для дома не может быть установлено'),
    (16, 'Соответствие для квартиры не может быть установлено'),
    (17, ''),
    (18, 'Исправлена')
;
